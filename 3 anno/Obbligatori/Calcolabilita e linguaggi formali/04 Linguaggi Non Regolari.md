...
>4. Senza sfruttare l'ipotesi $|xy|\le p$
>
>Avremo 3 casi : 
>5. $y$ contiene solo $0$ 
...
>
>---
>8. Sfruttando l'ipotesi $|xy| \le p$
>
...
>9. $s$ sta nel linguaggio
>10. $l=2p+2\ge p$ 
>11. Dividiamo la stringa in $s=xyz$ dove $|y|>0$ e $|xy|\le p$ , sfruttando la terza ipotesi del [[Pumping Lemma]] sappiamo che $y$ dovrà stare sicuramente tra i primi $0$ ( poichè $0$ si ripete $p$ volte e quindi $xy$ dovranno per forza essere solo $0$ ) 
