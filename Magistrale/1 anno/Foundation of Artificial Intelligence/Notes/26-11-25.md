...
better than handcrafted feature extraction since they will be general 

unsupervised learning 

compare generative classifier and deep learning classifier

---

wandb -> db for weights
dataloader -> pass smoething that can get the data 

torchvision

tensor -> extension of numpy arrays -> can reside in a particular gpu device -> can track operations that you are doing -> can do automatic differentiation 

provide loss and than take optimizer -> gradiant descent etcc 

than simply train the model for each batch 